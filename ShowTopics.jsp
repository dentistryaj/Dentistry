        ...
        <table border="1" cellpadding="5">
            ...
            <c:forEach var="topic" items="${listTopics.rows}">
                <tr>
                    ...
                    <td><a href="images/images/${topic.topic_link}">View image</a></td>
                    <td><a href="javascript:confirmGo('Sure to delete this record?','DeleteTopic.jsp?id=<c:out value="${topic.id}"/>')">Delete</a></td>
                </tr>
            </c:forEach>
        </table>
    </div>
